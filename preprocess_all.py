...
def build_save_dataset(corpus_type, fields, opt):
    ...
    if corpus_type == 'train':
        ...
        src_corpus = opt.all_src
        tgt_corpus = opt.all_tgt
    ...
    if opt.data_type == 'text':
        ...
        if corpus_type == 'train':
            ...
            label_corpus = opt.test_label
            node1_corpus = opt.test_node1
            node2_corpus = opt.test_node2
        else:
            label_corpus = opt.all_label
            node1_corpus = opt.all_node1
            node2_corpus = opt.all_node2
...
def main():
    ...
    print("Building & saving all data...")
    all_dataset_files = build_save_dataset('all', fields, opt)

    print("Building & saving vocabulary...")
    build_save_vocab(all_dataset_files, fields, opt)

    print("Building & saving training data...")
    build_save_dataset('train', fields, opt)
    
    print("Building & saving valid data...")
