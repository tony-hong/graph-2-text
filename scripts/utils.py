...
PROPERTY_MAP_MINI = {
    ...
    'fr' : ['Tense', 'Definite', 'Mood', 'Number', 'Gender', 'lin']
}

PROPERTY_MAP = {
    'en' : ['Tense', 'Degree', 'Definite', 'Number', 'PronType', 'Poss', 'lin', 'ClauseType'],
    'es' : ['NumForm', 'Definite', 'Tense', 'Reflex', 'Poss', 'Gender', 'ClauseType', 'NumType', 'Degree', 'Mood', 'Person', 'PronType', 'Number', 'Polite', 'AdpType', 'A3_hasDuplicate', 'lin', 'Foreign', 'Voice', 'Aspect', 'AdvType'], 
    'fr' : ['Tense', 'Definite', 'Mood', 'Number', 'Gender', 'lin', 'ClauseType']
}
