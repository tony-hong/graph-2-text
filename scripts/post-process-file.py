...
if __name__ == '__main__':
    ...
    prs.add_argument('-l', '--lexicon',
                     help='Specify path of lexicons. ',
                     required=True)
    prs.add_argument('-b', '--labels',
                     help='Specify path of labels. ',
                     required=True)
    ...
    output_name = re.findall(r'-lexicon/(.*)\.entity\.json', lexicon_fn)[-1]
    print ('output_name:', output_name)

    tokenised_sent_fn = output_dir + output_name + '-lex_token.txt'
    untokenised_sent_fn = output_dir + output_name + '-lex_detoken.txt'
