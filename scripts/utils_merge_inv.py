...
#             assert line[2] == '_'
        ...
        for edge_idx, edge in enumerate(edges, start=0):
            if edge[-1] == 'V':
                # change direction for inverse tag
                parent = child_list[edge_idx]
                child = parent_list[edge_idx]
        ...
        return new_line, output_sent, entity_lemma_dict, nodes_line, feats_line, labels_line, node1_line, node2_line, property_keys
