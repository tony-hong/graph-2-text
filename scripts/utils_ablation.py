...
#             assert line[2] == '_'
        ...
        if property_vocab: 
            ...
            for idx, delex_lemma in enumerate(delex_lemma_list):
                ...
                property_postfix = property_seperator + property_seperator.join(property_str_list)
                
                # ablation for seq2seq
                dep = dep_list[idx]
                sem_tag = sem_tag_list[idx]
                
                dep_postfix = property_seperator + dep
                sem_tag_postfix = property_seperator + sem_tag
                
                node_str = delex_lemma + property_postfix + dep_postfix + sem_tag_postfix
