...
def get_objDet_embeddings(file, idx2imageID_file, embeddings_all, opt):
    embs = embeddings_all
...
def main():
    ...
    embeddings_all = dict()
    get_objDet_embeddings(opt.train_emb_file, opt.train_idx_to_imageID, embeddings_all, opt)
    get_objDet_embeddings(opt.valid_emb_file, opt.valid_idx_to_imageID, embeddings_all, opt)
    get_objDet_embeddings(opt.test_emb_file, opt.test_idx_to_imageID, embeddings_all, opt)
